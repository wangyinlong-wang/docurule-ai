...
> 实施状态（2026-08-12）：当前仓库已经实现三文档采购三单匹配 Hero Demo、双文档医疗理赔 Demo、字段证据、规则重算、人工决定、JSON 审计导出、Docker 与 Ollama。规则模板化、乐观锁、独立审计实体和持久化任务运行器仍属于后续目标，不能视为现成功能。当前能力以 README 和自动化测试为准。
